...
@interface BaseTableViewController ()<UIAccelerometerDelegate>
...
- (void)viewDidLoad {
    ...
    // 添加刷新控件
    __block BaseTableViewController *list = self;
...
{
    NSUserDefaults *ud = [NSUserDefaults standardUserDefaults];
    NSString *temp = [ud objectForKey:@"jokes"];
